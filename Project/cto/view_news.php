...
$dataL = $connPDO->prepare("SELECT * FROM notification");
$dataL->execute();
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-1">
        ...
        <li class="nav-item">
          <a class="nav-link active text-capitalize" href="view_news.php">Notification</a>
        </li>
        <li class="nav-item">
...
<table class="table table-striped "  >
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td><button id="b" class="b<?php echo$i; ?>"><?php echo $row['title']; ?></button></td>
