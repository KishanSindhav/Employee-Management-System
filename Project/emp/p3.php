...
session_start();
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO `feedback`(`pid`,`uid`, `feedback`) 
            VALUES ('$_pid','$uid','$feedback')";
...
h2{
  ...
  <body style="background-color: 	#FDF5E6 ;">  
    <!-- <div class="navbar2">
      ...
      <ul>
          <li class="ab2" ><a href="index.php">Home</a></li>
          <li><a href="p2.php">Notification</a></li>
          <li class="active2"><a href="view_project.php">Project</a>
          </li>
          <li><a href="p4.php">About</a></li>
          <div class="dropdown">
              <button class="dropbtn">...
                <i class="fa fa-caret-down"></i>
              </button>
              <div class="dropdown-content">
              <a href="user_detail.php">Your details</a>
              <a href="view_project.php">Project</a>
  ...
  <div class="fa">
    ...
    <a id="bn" class="btn btn-info" href="view_project.php">Back</a>
    </body>
</html>